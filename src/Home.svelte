...
<main>
  ...
  <div class="position-fixed" style="right: 10px; bottom: -5px; z-index: 9999;">
    <button type="button" class="btn py-2 px-0 border border-white bg-success text-white" on:click={openModal}>
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="35" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
