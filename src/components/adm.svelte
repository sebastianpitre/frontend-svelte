    ...
    <main class="main-content position-relative border-radius-lg ps">
        ...
        <div class="container-fluid py-4">
                        ...
                        <div class="card-body p-3">
                            <div class="chart">
                                <canvas id="chart-line" class="chart-canvas" height="300"
                                    style="display: block; box-sizing: border-box; height: 300px; width: 557.1px;"
                                    width="557"></canvas>
                            </div>
                        </div>
                    </div>
          ...
          background-size: cover;">
                                ...
                                <div class="carousel-item h-100 active" style="background-image: url('../../assets/img/img-3.jpg');
          background-size: cover;">
                                    <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                        <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
