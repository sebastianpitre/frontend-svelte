<script>
  import NavPc from './../components/nav_desktop.svelte';
</script>
...
<div class="position-sticky z-index-sticky top-0 mb-6">
  <div class="row">
    <div class="col-12">
          ...
          <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
            <ul class="navbar-nav navbar-nav-hover ms-auto">
              ...
              <li class="nav-item dropdown dropdown-hover my-1">
                <a href="calcular.html" class="btn btn-sm bg-gradient-success mb-0">Registro</a>
              </li>
